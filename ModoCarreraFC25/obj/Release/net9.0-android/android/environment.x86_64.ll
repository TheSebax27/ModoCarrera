...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x2c192a0a7fa0db94, ; from name: aot-ModoCarreraFC25.so
		i64 u0x3fbffb39740898a8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ModoCarreraFC25.dll.so
		ptr null; void* handle
	}, ; 130
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x387264025aecd761, ; from name: aot-ModoCarreraFC25.dll.so
		i64 u0x3fbffb39740898a8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ModoCarreraFC25.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x39daf9f1c826554b, ; from name: libaot-ModoCarreraFC25.so
		i64 u0x3fbffb39740898a8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ModoCarreraFC25.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x3fbffb39740898a8, ; from name: libaot-ModoCarreraFC25.dll.so
		i64 u0x3fbffb39740898a8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ModoCarreraFC25.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8675f235fe68cf52, ; from name: ModoCarreraFC25
		i64 u0x3fbffb39740898a8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ModoCarreraFC25.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8e91b511b150e5aa, ; from name: ModoCarreraFC25.dll.so
		i64 u0x3fbffb39740898a8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ModoCarreraFC25.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb1f180fb268228a7, ; from name: ModoCarreraFC25.so
		i64 u0x3fbffb39740898a8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ModoCarreraFC25.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xed1d3045a15b0169, ; from name: aot-ModoCarreraFC25
		i64 u0x3fbffb39740898a8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ModoCarreraFC25.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf0c2d8000d47760c, ; from name: libaot-ModoCarreraFC25
		i64 u0x3fbffb39740898a8, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ModoCarreraFC25.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.companyname.modocarrerafc25\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [30 x i8] c"libaot-ModoCarreraFC25.dll.so\00", align 16
